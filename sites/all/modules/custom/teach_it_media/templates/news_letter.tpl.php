                                                                        ...
                                                                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" width="60">
                                                                                        <img src="<?php echo $logo; ?>" alt="Logo" title="Logo" width="60" height="60" data-max-width="100"></td>
                                                                                    ...
                                                                                    <td valign="middle" style='vertical-align: middle;'>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                                                                                                <h1 class='big'><a target='_blank' href="<?php echo $base_url;?>" style='color:#444444'>TeachIT Media</a></h1>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                            <div class='contentEditable' style='text-align: center;'>
                                                                                                <br>
                                                                                                <p>Here is what's new on TEACH IT over the past few days. Your comments and feedback are always welcome.
                                                                                                </p>
                                                                                                <br>
                                                                                            </div>
                                                                                        </div>
                                                                      ...
                                                                      <tr>
                                                                          <td class="specbundle" valign="top" width="142" align="center"><div class='contentEditableContainer contentImageEditable'>
                                                                                  <div class='contentEditable'>
                                                                                      <img src="<?php echo $content[0]['image']; ?>" alt="side image" width='142' height='142' data-default="placeholder" border="0">
                                                                                  </div>
                                                                              </div></td>
                                                                                      ...
                                                                                      <td>
                                                                                          <div class='contentEditableContainer contentTextEditable'>
                                                                                              <div class='contentEditable' style='text-align: left;'>
                                                                                                  <h2 style='font-size:16px;'><?php echo $content[0]['url']; ?></h2>
                                                                                                  <br>
                                                                                                  <p><?php echo truncate_utf8($content[0]['body'], 400, TRUE, TRUE) ; ?></p>
                                                                                                  <br>
                                                          ...
                                                          <tr>
                                                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      ...
                                                                      <tr>
                                                                          <td valign="top" class="specbundle"><table width="100%" cellpadding="0" cellspacing="0" align="center">
                                                                                  ...
                                                                                  <tr>
                                                                                      <td>
                                                                                          <div class='contentEditableContainer contentTextEditable'>
                                                                                              <div class='contentEditable' style='text-align: left;'>
                                                                                                  <h2 style='font-size:16px;'><?php echo $content[1]['url']; ?></h2>
                                                                                                  <br>
                                                                                                  <p><?php echo truncate_utf8($content[1]['body'], 400, TRUE, TRUE) ?></p>
                                                                                                  <br>
                                                                                                  <a target='_blank' href="#" class='link4' style='color:#27A1E5;' >read more</a>
                                                                                              </div>
                                                                                          </div>
                                                                          ...
                                                                          <td class="specbundle" valign="top" width="142" align="center"><div class='contentEditableContainer contentImageEditable'>
                                                                                  <div class='contentEditable'>
                                                                                      <img src="<?php echo $content[1]['image']; ?>" alt="side image" width='142' height='142' data-default="placeholder" border="0">
                                                                                  </div>
                                                                              </div></td>
                                                                      </tr>
                                                                      </tbody>
                                                          ...
                                                          <tr>
                                                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      ...
                                                                      <tr>
                                                                          <td class="specbundle" valign="top" width="142" align="center"><div class='contentEditableContainer contentImageEditable'>
                                                                                  <div class='contentEditable'>
                                                                                      <img src="<?php echo $content[2]['image']; ?>" alt="side image" width='142' height='142' data-default="placeholder" border="0">
                                                                                  </div>
                                                                              </div></td>
                                                                          <td width="20" valign="top" class="spechide"></td>
                                                                          <td class="specbundle"><table width="100%" cellpadding="0" cellspacing="0" align="center">
                                                                                  ...
                                                                                  <tr>
                                                                                      <td>
                                                                                          <div class='contentEditableContainer contentTextEditable'>
                                                                                              <div class='contentEditable' style='text-align: left;'>
                                                                                                  <h2 style='font-size:16px;'><?php echo $content[2]['url']; ?></h2>
                                                                                                  <br>
                                                                                                  <p><?php echo truncate_utf8($content[2]['body'], 400, TRUE, TRUE) ?></p>
                                                                                                  <br>
                                                                                                  <a target='_blank' href="#" class='link4' style='color:#27A1E5;' >read more</a>
                                                                                              </div>
                                                                                          </div>
